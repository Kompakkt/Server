...
export namespace SketchfabSchemas {
  ...
  export const PartialModelFromModelsResponseSchema = t.Partial(t.Pick(ModelSchema, ['uid', 'name', 'description', 'license', 'thumbnails', 'isDownloadable']));
  export type PartialModelFromModelsResponse = UnwrapSchema<typeof PartialModelFromModelsResponseSchema>;
