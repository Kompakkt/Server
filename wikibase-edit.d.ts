declare module 'wikibase-edit' {
  ...
  export interface WikibaseEditAPI {
    ...
    label: {
      set: (params: { id: string; language: string; value: string }) => Promise<EntityIdResponse>;
    };
    description: {
      set: (params: { id: string; language: string; value: string }) => Promise<EntityIdResponse>;
    };
    ...
    badge: {
      add: (params: { id: string; site: string; badges: string[] }) => Promise<EntityResponse>;
      remove: (params: { id: string; site: string; badges: string[] }) => Promise<EntityResponse>;
    };
  ...
  export default function wikibaseEdit(config?: WikibaseEditConfig): WikibaseEditAPI;
}
